...
> Consolidação documental de 13/09/2026. Fonte: [original preservado](../versao-claude/Regras/competencias.md). Versão de trabalho para teste; balanceamento ainda sem playtest registrado.

Status: v1 — lista fechada. Sincronizado com `regras-partida-piloto.md` v2 (28/08/2026).
...
- **Armas Pesadas** — machados grandes, marretas, picaretas, lanças pesadas, armas de duas mãos *(combate)*. É a única competência que permite **ataque pesado**, ou seja, ferir alguém de pé e inteiro
...
- **Armas de Fogo** — pistolas, rifles, espingardas; manutenção é Mecânica *(combate)*
- **Busca** — vasculhar ambientes, achar esconderijos, notar detalhes deliberadamente
- **Rastrear** — seguir trilhas, ler sinais de passagem, caçar
- **Sobrevivência** — forragear, montar abrigo, ler clima e terreno, orientar-se
- **Intuição** — ler intenções, perceber mentiras, sentir que algo está errado
- **Avaliar** — estimar valor, qualidade e autenticidade de itens e mercadorias

## Intelecto

- **Medicina** — tratar Ferimentos, estancar Sangramento sob pressão, cirurgia, diagnóstico, doenças
...
1. ~~**Defesa**~~ — **RESOLVIDO (v2)**: aparar usa a proficiência da arma empunhada; esquivar usa **Acrobacia**. Sem valor derivado. O Peso da armadura desconta de Acrobacia, então quem veste pesado apara e quem veste leve esquiva — a escolha vem do equipamento, não de uma regra separada.
...
6. **Ranks e habilidades**: rank de competência funciona como PRÉ-REQUISITO de habilidades do grafo (ex.: "Golpe Duplo" exige Armas Leves Mestre). Ranks NÃO concedem habilidades automáticas — evita recriar classes. Sensação de "destravar" ao subir rank será tratada na economia de progressão (roadmap 5.2).
