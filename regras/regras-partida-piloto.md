...
> Consolidação documental de 13/09/2026. Fonte: [original preservado](../versao-claude/Regras/regras-partida-piloto.md). Versão de trabalho para teste; balanceamento ainda sem playtest registrado.

> **Ler antes de mestrar:** o procedimento original abaixo foi incorporado integralmente, com referências atualizadas. As ambiguidades internas estão em [divergências](../ideias/divergencias.md): gravidade do ataque inimigo, manobras, Alerta, defesas do inimigo, Fôlego mínimo, Coisas e habilidades. As tabelas de simulação são registros históricos, com limitações demonstradas em [auditoria](../playtests/auditoria-simulador.md).

Status da fonte: consolidado em 28/08/2026. Incorpora as decisões manuscritas no GUIA DO JOGADOR e a rodada de design do dia 28 (eixo de tipo de dano, filosofia de Ferimentos, lore dos Corrompidos).
...
**Um Corrompido não é um encontro. É um acontecimento.** Se aparecer um, a pergunta que a mesa deve fazer é "*por que existe um aqui?*", não "*como matamos isso?*". Ver [cânone de mundo](../worldbuilding/canone-do-mundo.md).
