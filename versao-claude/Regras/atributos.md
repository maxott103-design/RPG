...
Status: v1 (28/08/2026). Este é o lugar onde os atributos e seus derivados estão descritos de forma fechada. Antes disso a informação estava espalhada entre `roadmap-desenvolvimento.md` (2.1) e `competencias.md`.
