...
> Ficha mecânica atual incorporada da [fonte Markdown](../versao-claude/Personagens/Ficha%2005%20%E2%80%94%20Meio-Orc%20Ca%C3%A7ador.md). Números verificados contra a criação documentada. Sem playtest registrado. As alternativas de habilidade continuam alternativas, não escolhas adicionais.
### O Homem do Norte
...
**Trecho biográfico em conflito:** a ficha de origem descreve fuga pulando do trem durante o transporte. A [decisão 0003](../decisoes/0003-passado-do-meio-orc.md) recupera um pedido explícito de anos de mineração escravizada e fuga sorrateira. A cronologia entre as duas versões não está comprovada. São variantes preservadas, não dois episódios automaticamente encadeados.

Após a fuga, sobreviveu sozinho.
...
| **Sobrevivência** | Prático | +2 | Percepção | sobreviveu sozinho após a fuga; modalidade em conciliação |
...
É o melhor personagem do grupo para lidar com a Wasteland: percepção, rastreamento e leitura de terreno. Em combate ele não atira — fecha a distância e usa a lança, que é uma das poucas armas do grupo capaz de causar Ferimento. É pouco instruído, mas possui conhecimentos práticos que nenhum personagem civilizado possui.
...
Bestas existem no mundo, mas ninguém do grupo tem uma. A regra ficou escrita na seção 6.1 do doc do mestre para quando aparecer na mão de um inimigo ou numa loja.

## Direção visual recuperada da versão GPT

Regata branca, suspensórios, braços expostos, calça simples, acessórios tribais; pedidos posteriores de casaco/capa e barba negra. Adaga robusta no cinto, cabo de osso natural. Sem arco.

## Conciliação necessária

O conceito enfatiza determinação e resistência adquirida na mineração; a ficha tem Vontade 1 e teto de Exaustão 2. Não alteramos atributos para resolver essa tensão de conceito sem decisão do autor. O [HTML histórico](../versao-claude/Personagens/ficha-meio-orc-pele-v2.html) usa arco, Intelecto 0, Fôlego 8 e habilidades antigas; não serve como ficha atual.
